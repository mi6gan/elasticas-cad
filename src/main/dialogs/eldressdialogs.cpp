#include "eldressdialogs.h"
namespace Elasticas
{
DressGoresDialog::DressGoresDialog(const QString & class_name):PropertiesDialog(trUtf8("Вытачки"),class_name)
{
    this->AddCheckBoxProperty(trUtf8("Вытачки"),"GoresOn",false);
}

//______________________________________________
    void DressBKBasicPropertiesDialog::apply()
    {        
        const Elasticas::CommonData & vars=Elasticas::Core::Instance()->CommonVariables();
        if(length_input_type_cb->GetCurrentId()) this->commonValue("Length")=this->length2_dsp->GetValue();
        else this->commonValue("Length")=this->length1_dsp->GetValue()-vars["Woman:T40"].toDouble();
        int silhouette_type=this->commonValue("SilhouetteType").toInt();
        this->commonValue("A1")=this->commonValue("Length");
        PropertiesDialog::apply();
        if(this->commonValue("SilhouetteType").toInt()!=silhouette_type) this->initDefaults();
    }

    void DressBKBasicPropertiesDialog::initDefaults()
    {
        int silhouette_type=this->commonValue("SilhouetteType").toInt();
        switch(silhouette_type)
        {
        case 0:
            this->commonValue("PT13")=this->commonValue("PT13:Default")=1.0f;
            this->commonValue("PT15")=this->commonValue("PT15:Default")=4.0f;
            this->commonValue("PT18")=this->commonValue("PT18:Default")=5.0f;
            this->commonValue("PT19")=this->commonValue("PT19:Default")=3.0f;
            this->commonValue("PT31")=this->commonValue("PT31:Default")=-0.3f;
            this->commonValue("PT39")=this->commonValue("PT39:Default")=0.5f;
            this->commonValue("PT43")=this->commonValue("PT43:Default")=-0.7f;
            this->commonValue("PT45'")=this->commonValue("PT45':Default")=0.3f;
            this->commonValue("PT46")=this->commonValue("PT46:Default")=1.0f;
            this->commonValue("PT47'")=this->commonValue("PT47':Default")=0.7f;
            this->commonValue("PT70")=this->commonValue("PT70':Default")=2.5f;
        break;
        case 1:
            this->commonValue("PT13")=this->commonValue("PT13:Default")=1.0f;
            this->commonValue("PT15")=this->commonValue("PT15:Default")=3.0f;
            this->commonValue("PT18")=this->commonValue("PT18:Default")=4.0f;
            this->commonValue("PT19")=this->commonValue("PT19:Default")=2.5f;
            this->commonValue("PT31")=this->commonValue("PT31:Default")=-0.5f;
            this->commonValue("PT39")=this->commonValue("PT39:Default")=0.5f;
            this->commonValue("PT43")=this->commonValue("PT43:Default")=-1.0f;
            this->commonValue("PT45'")=this->commonValue("PT45':Default")=0.0f;
            this->commonValue("PT46")=this->commonValue("PT46:Default")=1.0f;
            this->commonValue("PT47'")=this->commonValue("PT47':Default")=0.5f;
            this->commonValue("PT70")=this->commonValue("PT70':Default")=2.5f;
        break;
        case 2:
            this->commonValue("PT13")=this->commonValue("PT13:Default")=1.0f;
            this->commonValue("PT15")=this->commonValue("PT15:Default")=5.0f;
            this->commonValue("PT18")=this->commonValue("PT18:Default")=0.0f;
            this->commonValue("PT19")=this->commonValue("PT19:Default")=3.5f;
            this->commonValue("PT31")=this->commonValue("PT31:Default")=0.0f;
            this->commonValue("PT39")=this->commonValue("PT39:Default")=0.5f;
            this->commonValue("PT43")=this->commonValue("PT43:Default")=0.0f;
            this->commonValue("PT45'")=this->commonValue("PT45':Default")=0.6f;
            this->commonValue("PT46")=this->commonValue("PT46:Default")=1.0f;
            this->commonValue("PT47'")=this->commonValue("PT47':Default")=0.9f;
            this->commonValue("PT70")=this->commonValue("PT70':Default")=2.5f;
        break;
    ...
    DressBKBasicPropertiesDialog::DressBKBasicPropertiesDialog(const QString & class_name):PropertiesDialog(trUtf8("Основные параметры"),class_name)
    {
        const CommonData & vars=Core::Instance()->commonVariables();
        double Vps=-24.894073+0.626460*vars["Woman:T1"].toDouble()+0.071291*vars["Woman:T16"].toDouble()-0.100910*vars["Woman:T19"].toDouble();
        this->commonValue("Pt:Default")=2.0f;
        this->commonValue("Pt:Min")=2.0f;
        this->commonValue("Pt:Max")=100.0f;
        this->commonValue("Pb:Default")=2.5f;
        this->commonValue("Pb:Min")=2.0f;
        this->commonValue("Pb:Max")=100.0f;
        this->commonValue("Pg2:Default")=2.0f;
        this->commonValue("Pg2:Min")=2.0f;
        this->commonValue("Pg2:Max")=3.0f;
        this->commonValue("BeltZipperLength:Default")=18.0f; // !!!
        this->commonValue("PTx:Default")=0; // PTx
        this->commonValue("PTy:Default")=0; // PTy
        this->commonValue("Length1:Default")=vars["Woman:T7"].toDouble()-vars["Woman:T9"].toDouble()+vars["Woman:T40"].toDouble(); //Длина юбки
        this->commonValue("Length1:Min")=vars["Woman:T7"].toDouble()-Vps+5.0+vars["T40"].toDouble(); //Длина юбки
        this->commonValue("Length1:Max")=vars["Woman:T7"].toDouble()-10.0+vars["T40"].toDouble(); //Длина юбки

        this->commonValue("Length2:Default")=vars["Woman:T7"].toDouble()-vars["Woman:T9"].toDouble(); //Длина юбки
        this->commonValue("Length2:Min")=vars["Woman:T7"].toDouble()-Vps+5.0; //Длина юбки
        this->commonValue("Length2:Max")=vars["Woman:T7"].toDouble()-10.0; //Длина юбки

        this->commonValue("A1")=this->commonValue("Length")=this->commonValue("Length:Default")=this->commonValue("Length1:Default").toDouble()-vars["Woman:T40"].toDouble();

        this->commonValue("BeltZipperLength:Min")=(vars["Woman:T19"].toDouble()-vars["Woman:T16"].toDouble())/2.0; //Длина юбки !!!
        this->commonValue("BeltZipperLength:Max")=100.0f; //Длина юбки !!!

        AbstractProperty* p1;
        ComboBoxProperty* cmbp1;
        const QString silhouette_type_names[]={trUtf8("Полуприлегающий"),trUtf8("Прилегающий"),trUtf8("Прямой"),NULL};
        this->AddComboBoxProperty(trUtf8("Силуэт"),silhouette_type_names,"SilhouetteType");

        const QString style_type_names[]={trUtf8("Втачной"),NULL};
        this->AddComboBoxProperty(trUtf8("Покрой"),style_type_names);

        const QString length_type_names[]={trUtf8("от шейной точки"),trUtf8("от талии"),NULL};
        this->commonValue("LengthInputType:Default")=1;
        length_input_type_cb=this->AddComboBoxProperty(trUtf8("Длина задаётся"),length_type_names,"LengthInputType");

        p1=length1_dsp=this->AddDoubleSpinBoxProperty(trUtf8("Длина (см)"),"Length1");
        p1->AddCondition(new ComboBoxCondition(length_input_type_cb,0));


        p1=length2_dsp=this->AddDoubleSpinBoxProperty(trUtf8("Длина (см)"),"Length2");
        p1->AddCondition(new ComboBoxCondition(length_input_type_cb,1));
        ...
        this->commonValue("SleeveLength:Default")=50;
...
//________________________________________________________________________________
    DressBKBasicSkewsPropertiesDialog::DressBKBasicSkewsPropertiesDialog(const QString & class_name):PropertiesDialog(trUtf8("Основные конструктивные швы"),class_name)
    {
        this->InitSkirtDressBKBasicSewsProperties();
    }
    //________________________________________________________________________________
    DressIMKVentPropertiesDialog::DressIMKVentPropertiesDialog(const QString & classname):PropertiesDialog(trUtf8("Разрезы и шлицы"),classname)
    {
        //this->InitStraightSkirtDressIMKVentProperties();
        this->AddCheckBoxProperty(trUtf8("Шлицы"),"VentsOn");


    }
//____________________________________________________________________-
    DressIMKClaspPropertiesDialog::DressIMKClaspPropertiesDialog(const QString & class_name):PropertiesDialog(trUtf8("Застёжка"),class_name)
    {
        this->InitTopGarmentsClaspProperties();
        //this->InitStraightSkirtDressIMKVentProperties();
    }
//____________________________________________________________________-
    DressMKNeckDialog::DressMKNeckDialog(const QString & class_name):PropertiesDialog(trUtf8("Горловина"),class_name)
    {
        this->InitTopGarmentsNeckProperties();
    }
//_______________________________________________________________________
    IMF1_10Dialog::IMF1_10Dialog():PropertiesDialog(trUtf8("ИМФ 1.10"),"ComplexDress:")
    {
        QFrame* frame;
        this->AddCheckBoxProperty(trUtf8("Расширение по горловине"),"",false);
        properties_widget->layout()->addWidget(frame=new QFrame); frame->setFrameShape(QFrame::HLine);

        this->AddCheckBoxProperty(trUtf8("Расширение по линии плеч"),"",false);
        properties_widget->layout()->addWidget(frame=new QFrame); frame->setFrameShape(QFrame::HLine);

        CheckBoxProperty* chbp0=this->AddCheckBoxProperty(trUtf8("Расширение по низу"),"",true);
            this->commonValue("kpn:Default")=1.5f;
            DoubleSpinBoxProperty* dsbp0=this->AddDoubleSpinBoxProperty("kpn, %","kpn");
            dsbp0->AddCondition(new CheckBoxCondition(chbp0,true));
        properties_widget->layout()->addWidget(frame=new QFrame); frame->setFrameShape(QFrame::HLine);

        chbp0=this->AddCheckBoxProperty(trUtf8("Фиксация по низу"),"",true);
            CheckBoxProperty* chbp1=this->AddCheckBoxProperty(trUtf8("Пояс"),"",false);
                chbp1->AddCondition(new CheckBoxCondition(chbp0,true));
                dsbp0=this->AddDoubleSpinBoxProperty(trUtf8("Ширина пояса, см"),"tmp2");
                dsbp0->AddCondition(new CheckBoxCondition(chbp1,true));
                dsbp0=this->AddDoubleSpinBoxProperty(trUtf8("Длина пояса, см"));
                dsbp0->AddCondition(new CheckBoxCondition(chbp1,true));
            chbp1=this->AddCheckBoxProperty(trUtf8("Тесьма"),"",false);
                chbp1->AddCondition(new CheckBoxCondition(chbp0,true));
        properties_widget->layout()->addWidget(frame=new QFrame); frame->setFrameShape(QFrame::HLine);
    }
//_______________________________________________________________________
IMF4_4Dialog::IMF4_4Dialog():PropertiesDialog(trUtf8("ИМФ 4.4"),"ComplexDress:")
{
    QFrame* frame;
    CheckBoxProperty* chbp0=this->AddCheckBoxProperty(trUtf8("Расширение по окату"),"",false);
        this->commonValue("kpo:Default")=1.5f;
        DoubleSpinBoxProperty* dsbp0=this->AddDoubleSpinBoxProperty("kpo, %","kpo");
        dsbp0->AddCondition(new CheckBoxCondition(chbp0,true));
    properties_widget->layout()->addWidget(frame=new QFrame); frame->setFrameShape(QFrame::HLine);

    chbp0=this->AddCheckBoxProperty(trUtf8("Расширение по низу"),"Extension",true);
        this->commonValue("kpn:Default")=1.5f;
        dsbp0=this->AddDoubleSpinBoxProperty("kpn, %","kpn");
        dsbp0->AddCondition(new CheckBoxCondition(chbp0,true));
    properties_widget->layout()->addWidget(frame=new QFrame); frame->setFrameShape(QFrame::HLine);

    chbp0=this->AddCheckBoxProperty(trUtf8("Фиксация по низу"),"",true);
        CheckBoxProperty* chbp1=this->AddCheckBoxProperty(trUtf8("Манжет"),"CuffsOn",false);
        chbp1->AddCondition(new CheckBoxCondition(chbp0,true));
            dsbp0=this->AddDoubleSpinBoxProperty(trUtf8("Ширина манжеты, см"),"CuffsWidth");
            dsbp0->AddCondition(new CheckBoxCondition(chbp1,true));
            dsbp0=this->AddDoubleSpinBoxProperty(trUtf8("Длина манжеты, см"),"CuffsLength");
            dsbp0->AddCondition(new CheckBoxCondition(chbp1,true));
        chbp1=this->AddCheckBoxProperty(trUtf8("Тесьма"),"",false);
        chbp1->AddCondition(new CheckBoxCondition(chbp0,true));
}
