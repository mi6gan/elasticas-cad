...
C2DMensjacketDialog::C2DMensjacketDialog( const QString            & name,
...
void C2DMensjacketDialog::Apply()
{
    qDebug() << "Apply.";
...
void C2DMensjacketDialog::Reject()
{
...
void C2DMensjacketDialog::Reset()
{
...
QList< QList< double > > C2DMensjacketDialog::defaults()
{
    this->Reset();
}
void C2DMensjacketDialog::requiredVariables()
{
